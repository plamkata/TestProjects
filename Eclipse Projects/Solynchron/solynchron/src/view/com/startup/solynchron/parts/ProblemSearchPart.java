...
import com.startup.solynchron.rcp.ProblemFormMultipageEditor;
...
public class ProblemSearchPart extends RCPFormPart {
	...
	private ProblemFormMultipageEditor editor;
	 ...
	 * 
	 */
	public ProblemSearchPart(ProblemFormMultipageEditor editor) {
		...
		tblResultsViewer.addDoubleClickListener(new IDoubleClickListener() {
			...
			public void doubleClick(DoubleClickEvent event) {
				...
				if (!selection.isEmpty() && selection.getFirstElement() != null) {
					...
					// TODO: bind the problem form to the selected problem
					String pageId = Resources.getResource("ProblemForm.title") + " " + problem.getId();
					FormEditorInput input = new FormEditorInput(
							Resources.getResource("OpenProblemFormAction.name"), problem);
					try {
						editor.openProblem(input);
						// TODO: select the problem page
						editor.setActivePage(pageId, input);
	...
	public static void main(String[] args)
    {
        ...
        RCPFormPart part = new ProblemSearchPart(null);
