 ...
 * $Id$
 */
package net.sf.rcpforms.emf.test.util;
...
public class TestAdapterFactory extends AdapterFactoryImpl {
	...
	protected TestSwitch<Adapter> modelSwitch =
		new TestSwitch<Adapter>() {
			...
			@Override
			public Adapter caseAddressModel(AddressModel object) {
				return createAddressModelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.sf.rcpforms.emf.test.TestModel <em>Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.sf.rcpforms.emf.test.ConfigurationModel <em>Configuration Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.sf.rcpforms.emf.test.AddressModel <em>Address Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAddressModelAdapter() {
		return null;
	}
