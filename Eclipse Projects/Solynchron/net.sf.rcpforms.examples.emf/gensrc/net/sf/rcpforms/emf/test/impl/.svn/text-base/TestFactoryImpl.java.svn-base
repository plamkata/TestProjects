...
public class TestFactoryImpl extends EFactoryImpl implements TestFactory {
	...
	public static TestFactory init() {
		try {
			TestFactory theTestFactory = (TestFactory)EPackage.Registry.INSTANCE.getEFactory("http://test/1.0"); //$NON-NLS-1$ 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TestPackage.TEST_MODEL: return createTestModel();
			case TestPackage.CONFIGURATION_MODEL: return createConfigurationModel();
			case TestPackage.ADDRESS_MODEL: return createAddressModel();
			default:
