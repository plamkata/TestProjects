...
void   MersRandomInit(void * Pthis, int ThisSize, int seed);    // Re-seed
void   MersRandomInitByArray(void * Pthis, int ThisSize, int const seeds[], int NumSeeds); // Seed by more than 32 bits
...
void   SFMTgenRandomInit(int seed, int IncludeMother);         // Re-seed
void   SFMTgenRandomInitByArray(int const seeds[], int NumSeeds, int IncludeMother); // Seed by more than 32 bits
...
void   SFMTRandomInit(void * Pthis, int ThisSize, int seed, int IncludeMother);  // Re-seed
void   SFMTRandomInitByArray(void * Pthis, int ThisSize, int const seeds[], int NumSeeds, int IncludeMother); // Seed by more than 32 bits
...
public:
   ...
   void RandomInit(int seed) {                             // Re-seed
      MersRandomInit(this, sizeof(*this), seed);}
   void RandomInitByArray(int const seeds[], int NumSeeds) {// Seed by more than 32 bits
      MersRandomInitByArray(this, sizeof(*this), seeds, NumSeeds);}
...
public:
   ...
   void RandomInit(int seed) {                             // Initialization
      MotRandomInit(this, sizeof(*this), seed);}
...
public:
   CRandomSFMTA(int seed, int IncludeMother = 1) {         // Constructor
      RandomInit(seed, IncludeMother);}
   void RandomInit(int seed, int IncludeMother = 1) {      // Re-seed
      SFMTRandomInit(this, sizeof(*this), seed, IncludeMother);}
   void RandomInitByArray(int const seeds[], int NumSeeds, int IncludeMother = 1) {// Seed by more than 32 bits
